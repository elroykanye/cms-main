                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;dogs/image3.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login" method="post">
                                        ...
                                        </div><button class="btn btn-primary btn-block text-white btn-user" type="submit" name="action" value="login" style="background: var(--purple);">Login</button>
                                        <hr>
                                    </form>
