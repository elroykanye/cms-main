                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="register" method="post">
                                ...
                                <div class="form-group" id="inputUserName"><input class="form-control form-control-user" type="text" name="username" placeholder="Username" required="" minlength="5"></div>
                                <div class="form-group row">
                                ...
                                <button class="btn btn-primary btn-block text-white btn-user" type="submit" style="background: var(--purple);">Register Account</button>
                                <hr>
                            </form>
