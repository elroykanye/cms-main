        ...
        <nav class="navbar navbar-dark sticky-top align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--indigo);height: 100%;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-play"></i><span>Apply for Contest</span></a></li>
                    <li class="nav-item">
                ...
                <div class="container-fluid">
                    ...
                    <section class="apply-content-section">
                        ...
                        <div class="form-container">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group"><label class="field-label-appl">First Name</label><input type="text" class="form-control form-control-user text-input-round-border text-input-appl" name="first-name" value="John"></div>
                                </div>
                                <div class="col">
                                    <div class="form-group"><label class="field-label-appl">Last Name</label><input type="text" class="form-control form-control-user text-input-round-border text-input-appl" name="first-name" value="Doe"></div>
                                </div>
                            </div>
                            <div class="row">
