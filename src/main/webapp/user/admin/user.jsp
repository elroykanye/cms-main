...
<%
    ...
    IO.println(request.getSession().getAttribute("currentUser"));
    if(user == null) response.sendRedirect("../../error/404.jsp");
%>
...
<head>
    ...
    <title><%= user.getUserName() %> - CMS</title>
            ...
            <div id="content">
                <nav syleClass="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top">
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form styleClass="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        ...
                        <ul styleClass="navbar-nav flex-nowrap ml-auto">
                            ...
                            <li stleClass="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#">Date<span class="d-none d-lg-inline mr-2 text-gray-600 small">Valerie Luna</span></a>
                                    <div styleClass="dropdown-menu shadow dropdown-menu-right animated--grow-in"><a class="dropdown-item" href="#"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Profile</a><a class="dropdown-item" href="#"><i class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Settings</a><a class="dropdown-item" href="#"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Activity log</a>
                                        <div styleClass="dropdown-divider"></div><a class="dropdown-item" href="#"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Logout</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">${currentUser.userFirstName} ${currentUser.userLastName}</h3>
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="form-row">
                                            <div class="col"><button class="btn btn-primary" type="button" style="background: var(--purple);">Save</button></div>
                                            <div class="col"><button class="btn btn-primary" type="button" style="background: var(--purple);">Delete</button></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="username"><strong>Username</strong></label><input class="form-control" type="text" id="username" placeholder="user.name" name="username" value="<%= user.getUserName() %>"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="email"><strong>Email Address</strong></label><input class="form-control" type="email" id="email" placeholder="user@example.com" name="email" value="<%= user.getUserEmail() %>"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
                                                        <div class="form-group"><label for="first_name"><strong>First Name</strong></label><input class="form-control" type="text" id="first_name" placeholder="John" name="first_name" value="<%= user.getUserFirstName() %>"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="form-group"><label for="last_name"><strong>Last Name</strong></label><input class="form-control" type="text" id="last_name" placeholder="Doe" name="last_name" value="<%= user.getUserLastName() %>"></div>
                                                    </div>
                                                </div>
                                                <div class="form-row">
                                                    <div class="col">
